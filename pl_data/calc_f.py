...
def calc_e2e(node1,node2):
    ...
    t2 = []
    t3 = []
    print(len(node1["Publication_publish"]))
...
n1 = collect('./log_node1_1373781')
n2 = collect('./log_node2_1373782')
n3 = collect('./log_node3_1373788')
n4 = collect('./log_node4_1373791')


t1,t2,t3 = calc_e2e(n2,n4)
